export const CONFIG = {
  ...
  // ۱۶ مدل قابل انتخاب Gemini در پنل مدیریت
  GEMINI_MODELS: [
    { id: "gemini-2.5-flash", name: "⚡ Gemini 2.5 Flash (پیش‌فرض)" },
...
قوانین کلیدی:
۱. اگر کاربر سوالی پرسید که به اطلاعات زنده روز (نرخ ارز، طلا، سکه، اخبار جدید یا رویدادها) نیاز دارد، فوراً عبارت [[SEARCH:عبارت جستجو]] را در پاسخت قرار بده تا اطلاعات تازه دریافت شود.
